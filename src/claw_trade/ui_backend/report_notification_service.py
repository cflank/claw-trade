...
class ReportNotificationService:
    ...
    def notify_report_completion(self, report_id: str) -> dict[str, object]:
    ...
    def request_full_report_file(self, report_id: str, request_id: str, *, channel_kind: str = "wechat_clawbot") -> dict[str, object]:
        ...
        payload = self._repository.read_pdf_bytes(report_id, latest_pdf.pdf_artifact_id)
        try:
