...
description: Stage contract for `hot_money_tracker` in the claw-trade OpenClaw report path.
---
...
- Output the final reader-facing report body for `hot_money_analysis_report`.
