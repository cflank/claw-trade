...
description: Stage contract for `policy_analyst` in the claw-trade OpenClaw report path.
---
...
- Output the final reader-facing report body for `policy_analysis_report`.
