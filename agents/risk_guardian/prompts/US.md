...
Data evidence boundary (check before debating data conflicts): {data_evidence_summary}
If analyst claims conflict with this evidence boundary, do not amplify the conflicting number or fact; state the conflict and treat the claim as unverified.
