...
- If the current profile is CRYPTO, use the approved CRYPTO prompt plus `crypto-trading-analysis` and the `claw_request_data` claw-trade data layer material. Do not fallback to US, CN_A, or HK.
