...
- Keep report markdown reader-facing; do not append fenced JSON PM decision blocks by hand.
- Machine identity/receipt/hash fields are generated by tool/control evidence, not by worker-authored markdown.
