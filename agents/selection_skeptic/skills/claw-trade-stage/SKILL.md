...
description: Stage contract for `selection_skeptic` in the claw-trade OpenClaw selection path.
---
...
- Output the canonical artifact named `selection_skeptic_review`.
