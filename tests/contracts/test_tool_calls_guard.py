...
def test_crypto_frontline_tool_calls_rejects_silent_required_data_tool_skip() -> None:
...
def test_crypto_frontline_tool_calls_rejects_recorded_without_required_data_tool() -> None:
    call = _crypto_social_call()
