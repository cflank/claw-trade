...
@pytest.mark.parametrize(
    ...
    [
        ...
        (SelectionWorkflowStatus.VALIDATING_CANDIDATE_CACHE, SelectionWorkflowStatus.CANDIDATE_CACHE_NOT_APPROVED),
        (SelectionWorkflowStatus.VALIDATING_CANDIDATE_CACHE, SelectionWorkflowStatus.CANDIDATE_CACHE_HASH_MISMATCH),
        (SelectionWorkflowStatus.VALIDATING_CANDIDATE_CACHE, SelectionWorkflowStatus.CANDIDATE_CACHE_INTEGRITY_FAILED),
        (SelectionWorkflowStatus.VALIDATING_CANDIDATE_CACHE, SelectionWorkflowStatus.CANDIDATE_CACHE_LINEAGE_INCOMPLETE),
