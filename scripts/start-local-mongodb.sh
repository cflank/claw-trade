...
RUNTIME_DIR="${CLAW_TRADE_LOCAL_MONGODB_RUNTIME_DIR:-${ROOT_DIR}/.runtime/mongodb}"
DOWNLOAD_DIR="${CLAW_TRADE_LOCAL_MONGODB_DOWNLOAD_DIR:-${RUNTIME_DIR}/downloads}"
DATA_DIR="${CLAW_TRADE_LOCAL_MONGODB_DATA_DIR:-${RUNTIME_DIR}/data}"
LOG_DIR="${CLAW_TRADE_LOCAL_MONGODB_LOG_DIR:-${RUNTIME_DIR}/log}"
RUN_DIR="${CLAW_TRADE_LOCAL_MONGODB_RUN_DIR:-${RUNTIME_DIR}/run}"
...
MONGO_EXTRACTED_DIR="${CLAW_TRADE_LOCAL_MONGODB_EXTRACTED_DIR:-${RUNTIME_DIR}/mongodb-linux-x86_64-${MONGO_PLATFORM}-${MONGO_VERSION}}"
MONGO_CURRENT_DIR="${CLAW_TRADE_LOCAL_MONGODB_CURRENT_DIR:-${RUNTIME_DIR}/current}"
