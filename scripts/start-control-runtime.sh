...
A_SHARE_FACTORY_SEED_PACKAGE="${A_SHARE_FACTORY_SEED_PACKAGE:-${ROOT_DIR}/data/current-seed-20260626.tar}"
A_SHARE_FACTORY_SEED_CHECKSUM="${A_SHARE_FACTORY_SEED_CHECKSUM:-${A_SHARE_FACTORY_SEED_PACKAGE}.sha256}"
A_SHARE_FACTORY_SEED_COLUMNAR_ROOT="${A_SHARE_FACTORY_SEED_COLUMNAR_ROOT:-${ROOT_DIR}/.runtime/factory-seeds/current-seed-20260626/normalized}"
