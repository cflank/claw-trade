...
CLAW_TRADE_DATA_WORK_LOCK_PATH="${CLAW_TRADE_DATA_WORK_LOCK_PATH:-${RUNTIME_DIR}/data-work-active.lock}"
CLAW_TRADE_ALLOW_DATA_WORK_LOCK_OVERRIDE="${CLAW_TRADE_ALLOW_DATA_WORK_LOCK_OVERRIDE:-1}"
...
A_SHARE_FACTORY_SEED_PACKAGE="${A_SHARE_FACTORY_SEED_PACKAGE:-${ROOT_DIR}/data/current-seed-20260715.tar}"
A_SHARE_FACTORY_SEED_CHECKSUM="${A_SHARE_FACTORY_SEED_CHECKSUM:-${A_SHARE_FACTORY_SEED_PACKAGE}.sha256}"
A_SHARE_FACTORY_SEED_COLUMNAR_ROOT="${A_SHARE_FACTORY_SEED_COLUMNAR_ROOT:-${ROOT_DIR}/.runtime/factory-seeds/current-seed-20260715/normalized}"
...
export CLAW_TRADE_DATA_WORK_LOCK_PATH
export CLAW_TRADE_ALLOW_DATA_WORK_LOCK_OVERRIDE
...
CLAW_TRADE_UI_PUBLIC_BASE_URL="${CLAW_TRADE_UI_PUBLIC_BASE_URL:-}"
...
write_runtime_env_var "CLAW_TRADE_DATA_WORK_LOCK_PATH" "${CLAW_TRADE_DATA_WORK_LOCK_PATH}"
write_runtime_env_var "CLAW_TRADE_ALLOW_DATA_WORK_LOCK_OVERRIDE" "${CLAW_TRADE_ALLOW_DATA_WORK_LOCK_OVERRIDE}"
...
write_runtime_env_var "CLAW_TRADE_UI_PUBLIC_BASE_URL" "${CLAW_TRADE_UI_PUBLIC_BASE_URL}"
