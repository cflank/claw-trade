...
- call 1: `claw_get_social_pack`
  args: `{"ticker":"00005.HK","market":"HK","company_name":"汇丰控股","start_date":"2025-05-17","end_date":"2026-05-17","current_date":"2026-05-17"}`
...
搜索发现：0 条，仅作公开讨论线索。
来源尝试：google_news/search_discovery：来源返回为空；eastmoney_hk_guba/social_metrics：远端请求失败；xueqiu_hk/posts：远端请求失败。
资料缺口：google_news/search_discovery returned empty social rows；social provider is not configured for live fetch: eastmoney_hk_guba/social_metrics；social provider is not configured for live fetch: xueqiu_hk/posts。
