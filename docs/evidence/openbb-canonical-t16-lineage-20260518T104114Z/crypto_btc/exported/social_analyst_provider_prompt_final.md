...
- call 1: `claw_get_social_pack`
  args: `{"ticker":"BTC","market":"CRYPTO","current_date":"2026-05-18","start_date":"2025-05-18","end_date":"2026-05-18"}`
...
来源尝试：polymarket/event_markets：来源返回为空；google_news/search_discovery：远端获取成功；lunarcrush/social_metrics：缺少接口凭证；alternative_me/fear_greed：远端获取成功；x/posts：缺少接口凭证。
资料缺口：polymarket/event_markets returned empty social rows；missing credential keys: LUNARCRUSH_API_KEY；missing credential keys: X_BEARER_TOKEN。
