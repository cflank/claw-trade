...
- call 1: `claw_get_fundamental_pack`
  args: `{"ticker":"AAPL","market":"US","current_date":"2026-05-18"}`
...
### tool_calls
- call 1: `claw_get_fundamental_pack`
  args: `{"ticker":"AAPL","market":"US","current_date":"2026-05-18","company_name":"Apple Inc.","profile":"full"}`
...
### tool_calls
- call 1: `claw_get_fundamental_pack`
  args: `{"ticker":"AAPL","market":"US","current_date":"2026-05-18","freshness_max_age_seconds":604800}`
...
### tool_calls
- call 1: `claw_get_fundamental_pack`
  args: `{"ticker":"AAPL","market":"US","current_date":"2026-05-18","currency":"USD"}`
