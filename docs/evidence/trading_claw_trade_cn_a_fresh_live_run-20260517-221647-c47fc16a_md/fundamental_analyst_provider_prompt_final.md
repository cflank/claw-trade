...
- call 1: `claw_get_fundamental_pack`
  args: `{"ticker":"600519.SH","market":"CN_A","start_date":"2026-02-01","end_date":"2026-05-17"}`
...
### tool_calls
- call 1: `claw_get_fundamental_pack`
  args: `{"ticker":"600519.SH","market":"CN_A","start_date":"2026-02-01","end_date":"2026-05-17","aliases":["贵州茅台","茅台"]}`
...
## 来源状态
- akshare.stock_financial_analysis_indicator：证据写入失败。
- tushare.fina_indicator+income+balancesheet+cashflow+fina_mainbz：证据写入失败。

## 资料缺口
- stock_financial_analysis_indicator：attempt id conflict with different payload: run-20260517-221647-c47fc16a:run-20260517-221647-c47fc16a-frontline-t00-fundamental_analyst-20260517T221647266323Z-809cf2ab:fundamental.akshare.cn_a:stock_financial_analysis_indicator
- fina_indicator+income+balancesheet+cashflow+fina_mainbz：attempt id conflict with different payload: run-20260517-221647-c47fc16a:run-20260517-221647-c47fc16a-frontline-t00-fundamental_analyst-20260517T221647266323Z-809cf2ab:fundamental.tushare.cn_a:fina_indicator+income+balancesheet+cashflow+fina_mainbz
