...
Latest world affairs news: The tool confirms that 24 news fact sources are available (20 official filings/company sources + 4 global/macroeconomic news items), plus 20 search discoveries as leads, and 0 event expectations. The SEC filings, FRED macro news, and Google News search discovery endpoints all returned successfully. 
