...
当前日期：2026-05-17。资料包分析区间：2025-05-17 至 2026-05-17。
...
- `claw_get_fundamental_pack` 调用参数必须使用：ticker=`BTC`，market=`CRYPTO`，company_name=`Bitcoin`，start_date=`2025-05-17`，end_date=`2026-05-17`。不要自行改成旧日期或其它市场区间。
...
- call 1: `claw_get_fundamental_pack`
  args: `{"ticker":"BTC","market":"CRYPTO","company_name":"Bitcoin","start_date":"2025-05-17","end_date":"2026-05-17"}`
...
- security.score: 73.83
- timezone: UTC
- valuation.market_cap_usd: 1.55699e+12
